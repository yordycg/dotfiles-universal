-- vim-herdr-navigation — Neovim side (vendored from plugin v0.1.0)
--
...
--
-- Vendored into ~/.config/herdr/editor/herdr_nav.lua and loaded via `dofile`
-- from both LazyVim and nvim-personal after their plugins load.
