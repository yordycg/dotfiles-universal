...
-- Zeron: controller de agentes de código (app desktop)
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd((os.getenv("HOME") or "") .. "/.local/bin/zeron"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("pgrep -x wvkbd-mobintl >/dev/null 2>&1 && pkill -RTMIN wvkbd-mobintl || wvkbd-mobintl -l simple")) -- teclado virtual (wvkbd)
