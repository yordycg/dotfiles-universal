...
miniclue.setup({
  ...
  clues = {
    ...
    { mode = "n", keys = "<leader>gD", desc = "Definition" },
    ...
    -- +code
    { mode = "n", keys = "<leader>or", desc = "Organize imports" },
    { mode = "n", keys = "<leader>ch", desc = "Clear search highlights" },
    -- +format/lint
    { mode = "n", keys = "<leader>mf", desc = "Format buffer/selection" },
    { mode = "n", keys = "<leader>ml", desc = "Toggle lint" },
    -- +paste/path
