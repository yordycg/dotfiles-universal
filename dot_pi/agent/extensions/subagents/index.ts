...
const PI_WEB_ACCESS = path.join(process.env.HOME || "~", ".pi", "agent", "npm", "node_modules", "pi-web-access", "index.ts");
const CUSTOM_TOOL_EXTENSIONS: Record<string, string> = {
	web_search: PI_WEB_ACCESS,
	web_fetch: PI_WEB_ACCESS,
	fetch_content: PI_WEB_ACCESS,
